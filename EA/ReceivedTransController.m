...
#import "ReceivedTransController.h"
#import "ReceivedTransCell.h"
#import "ProgressView.h"
#import "DataManager.h"
#import "TransDetailController.h"

@interface ReceivedTransController ()

@property (weak, nonatomic) IBOutlet UITableView *transTableView;

@property (nonatomic) NSDictionary* agent;
@property (nonatomic) NSMutableArray* transactions;

@end

@implementation ReceivedTransController
...
- (void)viewDidAppear:(BOOL)animated {
    ...
    NSString* agentId = NULL;
    if (self.agent == NULL)
        agentId = [backendless.userService.currentUser getObjectId];
    else
        agentId = [self.agent objectForKey:@"objectId"];
...
- (nonnull UITableViewCell *)tableView:(nonnull UITableView *)tableView cellForRowAtIndexPath:(nonnull NSIndexPath *)indexPath {
    ReceivedTransCell* cell = (ReceivedTransCell*) [tableView dequeueReusableCellWithIdentifier:@"receivedTransCell" forIndexPath:indexPath];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    ReceivedTransCell* cell = (ReceivedTransCell*) sender;
